...
Next we will clone the repository on the control host.

----
[root@control ~]# su - ansible
Letzte Anmeldung: Mittwoch, den 27. März 2019, 17:01:07 CET auf pts/1
[ansible@control ~]$ git clone git@control.example.com:gitea-repositories/git/structured-content.git
Cloning into 'structured-content'...
git@control.example.com's password:
