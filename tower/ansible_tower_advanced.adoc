...
generic code:: All content that will be used across multiple projects. In most cases this consists of link:https://docs.ansible.com/ansible/latest/user_guide/playbooks_reuse_roles.html[Ansible roles]. How a role itself is structured is link:https://galaxy.ansible.com/docs/contributing/creating_role.html[sufficiently described] and will not be part of this workshop. Instead we will focus on how to structure when multiple roles are used in parallel. 
