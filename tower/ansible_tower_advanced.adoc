...
* How to work with the Tower API
...
* All labs where prepared using *Vim*, but we understand not everybody loves it. Feel free to use an alternative editor, in the lab environment *Midnight Commander* (just run *mc*, function keys can be reached via Esc-<n>) and *Nano* (run *nano*) are installed on the control host.
