...
----
# tower-cli project create -n "Compliance Repository" --organization Default --scm-type git --scm-url http://control.example.com/gitea/git/compliance.git --scm-clean 1 --scm-update-on-launch 1 --scm-credential "Gitea credentials"
Resource changed.
== ===================== ======== =================================================== ==========================
...
----
# tower-cli job_template create -n "Compliance STIG packages" --job-type run -i "Example Inventory" --project "Compliance Repository" --playbook "tower/demo-playbooks/stig-packages.yml" --credential "Example Credentials" --become-enabled 1
Resource changed.
== ======================== ========= ======= ================= 
...
----
# tower-cli job_template create -n "Compliance STIG config" --job-type run -i "Example Inventory" --project "Compliance Repository" --playbook "tower/demo-playbooks/stig-config.yml" --credential "Example Credentials" --become-enabled 1
Resource changed.
== ====================== ========= ======= ===============
id          name          inventory project    playbook
== ====================== ========= ======= ===============
...
----
# tower-cli job_template create -n "Compliance CIS" --job-type run -i "Example Inventory" --project "Compliance Repository" --playbook "tower/demo-playbooks/cis.yml" --credential "Example Credentials" --become-enabled 1
Resource changed.
== ============== ========= ======= ========
id      name      inventory project playbook
== ============== ========= ======= ========
