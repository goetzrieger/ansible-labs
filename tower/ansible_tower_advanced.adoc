...
----
# tower-cli job_template create -n "Compliance STIG packages" --job-type run -i "Example Inventory" --project "Compliance Repository" --playbook "stig-packages.yml" --credential "Example Credentials" --become-enabled 1
Resource changed.
== ======================== ========= ======= ================= 
...
----
# tower-cli job_template create -n "Compliance STIG config" --job-type run -i "Example Inventory" --project "Compliance Repository" --playbook "stig-config.yml" --credential "Example Credentials" --become-enabled 1
Resource changed.
== ====================== ========= ======= ===============
id          name          inventory project    playbook
== ====================== ========= ======= ===============
...
----
# tower-cli job_template create -n "Compliance CIS" --job-type run -i "Example Inventory" --project "Compliance Repository" --playbook "cis.yml" --credential "Example Credentials" --become-enabled 1
Resource changed.
== ============== ========= ======= ========
id      name      inventory project playbook
== ============== ========= ======= ========
