...
Let's now assume that we also have external roles needed by our playbooks, those can either come from link:https://galaxy.ansible.com/[Ansible Galaxy] or, more commonly in an enterprise environment, directly from a (private) Git repository.
