...
The web browser of your laptop should default to the lab tool as startpage. On this web page *select the lab* your attending and enter the *Activation Key* that will be given by the lab instructor. 
